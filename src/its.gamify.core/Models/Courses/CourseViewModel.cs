...
public class CourseStateTransition<TResult>
{
    ...
    public Func<CourseCreateModel, Task<bool>>? Validate { get; set; }
    public Func<(Course course, CourseCreateModel model), Task<TResult>>? Action { get; set; }
}
...
public class LessonCreateModel
{
    ...
    public string? Type { get; set; } // "video", "article", or "quiz"
