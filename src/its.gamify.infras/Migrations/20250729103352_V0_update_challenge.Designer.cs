...
namespace its.gamify.infras.Migrations
{
    ...
    [Migration("20250729103352_V0_update_challenge")]
    partial class V0_update_challenge
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("its.gamify.domains.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 7, 29, 10, 33, 50, 754, DateTimeKind.Utc).AddTicks(2477),
                            Description = "",
                            IsDeleted = false,
                            Name = "EMPLOYEE",
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            UpdatedDate = new DateTime(2025, 7, 29, 10, 33, 50, 754, DateTimeKind.Utc).AddTicks(2480)
                        },
                        new
                        {
                            Id = new Guid("620d170e-c32e-4443-b450-32848c1eb5e9"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 7, 29, 10, 33, 50, 754, DateTimeKind.Utc).AddTicks(3479),
                            Description = "",
                            IsDeleted = false,
                            Name = "LEADER",
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            UpdatedDate = new DateTime(2025, 7, 29, 10, 33, 50, 754, DateTimeKind.Utc).AddTicks(3480)
                        },
                        new
                        {
                            Id = new Guid("3b72db68-b2c6-40d8-859e-b4996f8535a1"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 7, 29, 10, 33, 50, 754, DateTimeKind.Utc).AddTicks(3504),
                            Description = "",
                            IsDeleted = false,
                            Name = "TRAININGSTAFF",
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            UpdatedDate = new DateTime(2025, 7, 29, 10, 33, 50, 754, DateTimeKind.Utc).AddTicks(3504)
                        },
                        new
                        {
                            Id = new Guid("f7fa7c6b-f76a-4b95-8711-517eb8205a1a"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 7, 29, 10, 33, 50, 754, DateTimeKind.Utc).AddTicks(3509),
                            Description = "",
                            IsDeleted = false,
                            Name = "MANAGER",
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            UpdatedDate = new DateTime(2025, 7, 29, 10, 33, 50, 754, DateTimeKind.Utc).AddTicks(3509)
                        },
                        new
                        {
                            Id = new Guid("b002d347-66b9-4722-9547-5b2165abaa9f"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 7, 29, 10, 33, 50, 754, DateTimeKind.Utc).AddTicks(3512),
                            Description = "",
                            IsDeleted = false,
                            Name = "ADMIN",
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            UpdatedDate = new DateTime(2025, 7, 29, 10, 33, 50, 754, DateTimeKind.Utc).AddTicks(3512)
                        });
                });
